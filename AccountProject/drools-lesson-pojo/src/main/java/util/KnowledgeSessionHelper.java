...
public class KnowledgeSessionHelper {
    ...
    public static KieSession getStatefulKnowledgeSessionForJBPM(
            KieContainer kieContainer, String sessionName, String workItemName,WorkItemHandler workItemHandler) {
        KieSession session = getStatefulKnowledgeSessionWithCallback(kieContainer, sessionName);
        session.getWorkItemManager().registerWorkItemHandler(workItemName,workItemHandler);
